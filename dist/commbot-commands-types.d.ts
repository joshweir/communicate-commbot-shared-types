...
export declare namespace Commbot {
  type TSendCommandToCommbot = (
    command: TCommbotCommand["command"],
    args: TCommbotCommand["args"]
  ) => Promise<any>;
  type TBuildSendCommandToCommbot = (
    sns: SNSClient,
  ...
  const commbotCommands: readonly [
    "GENERIC_ALERT",
    "DLQ_ALERT",
  ...
  interface TCommbotCommandArgs {
    ...
    DLQ_CREATE_IGNORE_RULE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqIgnoreRuleRawRecord: DlqIgnoreRules.TDlqIgnoreRuleRawRecord;
      };
    DLQ_DELETE_IGNORE_RULE_SUCCESS: TWithOrigSlackMsg &
      DlqIgnoreRules.TIgnoreRuleKey;
    DLQ_DELETE_IGNORE_RULE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      DlqIgnoreRules.TIgnoreRuleKey;
    DLQ_REQUEUE_MESSAGE_SUCCESS: TWithOrigSlackMsg & {
      dlqMessageKey: Dlq.TDlqMessageKey;
    };
    DLQ_REQUEUE_MESSAGE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg & {
        dlqMessageKey: Dlq.TDlqMessageKey;
      };
    ...
    DLQ_DELETE_MESSAGE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg & {
        dlqMessageKey: Dlq.TDlqMessageKey;
      };
    ...
    DLQ_BULK_REQUEUE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqName: string;
      };
    ...
    DLQ_LIST_IGNORE_RULES_FAILURE: TFailureCommon &
      TWithOrigSlackMsg & {
        dlqName: string;
        region: Region;
        processingEnvironmentId: string;
    ...
    DLQ_RESUME_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    DLQ_PAUSE_SUCCESS: TWithOrigSlackMsg & TWithRegionAndDataEnv;
    DLQ_PAUSE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    ...
    DLQ_COUNT_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqName: string;
        n: number;
    ...
    DLQ_HEAD_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqName: string;
      };
    ...
    DLQ_TAIL_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqName: string;
      };
    ...
    DLQ_PICK_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        operationIdOrMessageId: string;
      };
    ...
    DLQ_CREATE_TRASH_RULE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv & {
        dlqIgnoreRuleRawRecord: DlqIgnoreRules.TDlqIgnoreRuleRawRecord;
      };
    DLQ_DELETE_TRASH_RULE_SUCCESS: TWithOrigSlackMsg &
      DlqIgnoreRules.TIgnoreRuleKey;
    DLQ_DELETE_TRASH_RULE_FAILURE: TFailureCommon &
      TWithOrigSlackMsg &
      DlqIgnoreRules.TIgnoreRuleKey;
    ...
    DLQ_LIST_TRASH_RULES_FAILURE: TFailureCommon &
      TWithOrigSlackMsg & {
        dlqName: string;
        region: Region;
        processingEnvironmentId: string;
    ...
    QDB_PAUSE_SUCCESS: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    QDB_PAUSE_FAILURE: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TFailureCommon &
      TWithRegionAndDataEnv;
    QDB_RESUME_SUCCESS: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    QDB_RESUME_FAILURE: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TFailureCommon &
      TWithRegionAndDataEnv;
    QDB_RESTART_SUCCESS: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    QDB_RESTART_FAILURE: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TFailureCommon &
      TWithRegionAndDataEnv;
    QDB_WARM_TO_HOT_SUCCESS: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TWithRegionAndDataEnv;
    QDB_WARM_TO_HOT_FAILURE: TQDBCommandArgsCommon &
      TWithOrigSlackMsg &
      TFailureCommon &
      TWithRegionAndDataEnv;
    ...
    GET_ENTITY_FAILURE: TWithOrigSlackMsg &
      TWithRegionAndDataEnv &
      TFailureCommon;
    CW_ALERT: {
      alert: Cw.TCWAlert;
  ...
  type TCommbotCommandProcessor<C extends TCommbotCommandType> = (
